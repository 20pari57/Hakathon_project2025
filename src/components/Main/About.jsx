        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Arijita Paria and I am a full stack developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                        id='my-description'
                        defaultMessage='I am Arijita Paria, a passionate Frontend Developer and 2nd-year B.Tech CSE student from Kolkata. I specialize in building interactive, modern UI, AI-assisted projects, and clean responsive web experiences. My interests include AI, ML, Cybersecurity, and cinematic web design.'
                    />
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        <p><span>Email:</span> arijitaparia@example.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
